  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col xl:flex-row items-center xl:items-start justify-center gap-12 py-6">
        ...
        {/* ========================================================================= */}
        {/* MOBILE SCREEN 1: DASHBOARD VIEW */}
        {/* ========================================================================= */}
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="w-[375px] h-[812px] bg-[#F7F9FC] text-[#0D121F] rounded-[48px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] border-[12px] border-[#090D16] flex flex-col justify-between overflow-hidden relative font-sans selection:bg-indigo-200">
            ...
            <header className="pt-8 px-6 pb-2 flex items-center justify-between bg-white/70 backdrop-blur-md border-b border-slate-100 sticky top-0 z-20">
              ...
              <button className="p-2 rounded-full hover:bg-slate-100 transition-colors text-slate-600 relative">
              ...
              <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 space-y-4">
                ...
                <div className="relative pt-2">
                  <svg className="w-full h-24 overflow-visible" viewBox="0 0 300 100" preserveAspectRatio="none">
                    ...
                    {/* Fill Area */}
                    <path 
                      d="M 0 70 Q 40 72 75 80 T 150 40 T 225 90 T 300 35 L 300 90 L 0 90 Z" 
                      fill="url(#chartGlow)" 
                    />
                    
                    {/* Line Path */}
                    <path 
                      d="M 0 70 Q 40 72 75 80 T 150 40 T 225 90 T 300 35" 
                      fill="none" 
                      stroke="#2563EB" 
                      strokeWidth="3.5" 
                      strokeLinecap="round"
        ...
        {/* ========================================================================= */}
        {/* MOBILE SCREEN 2: RISK ASSESSMENT */}
        {/* ========================================================================= */}
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="w-[375px] h-[812px] bg-[#F7F9FC] text-[#0D121F] rounded-[48px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] border-[12px] border-[#090D16] flex flex-col justify-between overflow-hidden relative font-sans selection:bg-indigo-200">
              ...
              <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 space-y-4">
                ...
                <div className="flex justify-center py-2 relative">
                  <svg className="w-48 h-48 overflow-visible" viewBox="0 0 100 100">
                    ...
                    {/* Vertices points: Growth(50, 10), Agility(90, 40), Stability(75, 85), Security(25, 85), Diversification(10, 40) */}
                    {/* Custom Value polygon based on Growth Persona: Growth=100%, Agility=80%, Stability=70%, Security=65%, Diversification=75% */}
                    {/* Points: (50, 10), (82, 42), (67.5, 74.5), (33.75, 72.75), (20, 45) */}
                    <polygon 
                ...
                <div className="space-y-2.5">
                  ...
                  <button 
                    ...
                    className={`w-full p-3.5 rounded-2xl text-left border flex items-center justify-between transition-all ${
                      selectedGoal === 'wealth'
                        ? 'border-blue-600 bg-blue-50/40 shadow-sm shadow-blue-500/05'
            ...
            <footer className="border-t border-slate-100 bg-white py-4 px-6 flex items-center gap-4 sticky bottom-0 z-20">
              <button 
                ...
                className="flex-1 py-3 text-xs font-extrabold text-blue-600 border border-blue-600 rounded-xl hover:bg-blue-50/50 transition-colors text-center"
              >
                Previous
              </button>
              <button 
                onClick={() => setStep(prev => Math.min(5, prev + 1))}
                className="flex-1 py-3 text-xs font-extrabold text-white bg-[#0A1931] rounded-xl hover:bg-slate-900 transition-colors flex items-center justify-center gap-1.5"
              >
                <span>Next Step</span>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
